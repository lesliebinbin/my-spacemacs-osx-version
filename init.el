...
before packages are loaded."
  ...
  (load-file "~/.spacemacs.d/projectile-config.el")
  (config-projectile)
  ;;config the projectile
  ;;config remote-dir
  ...
  ;;config remote-dir
  ;;config the gradlew
  (load-file "~/.spacemacs.d/gradlew-config.el")
  (config-the-gradlew)
  ;;config the gradlew
  ;;config latex
  (load-file "~/.spacemacs.d/my-latex-config.el")
  (my-config-latex)
  ;;config latex
  ;;config pdf-tools
  (load-file "~/.spacemacs.d/my-pdf-tools.el")
  (config-my-pdf-tools)
  ;;config pdf-tools
  ;;config-geolocation
  ...
  (config-my-emmet)
  ;;config golang
  (load-file "~/.spacemacs.d/my-golang-config.el")
  (config-my-golang)
  ;;config golang
