...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval setq-local cmake-ide-project-dir my-project-dir)
     ...
     (eval setq-local my-project-dir
           (file-truename
