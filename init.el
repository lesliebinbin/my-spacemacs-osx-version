...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
     ...
     latex-preview-pane
     pretty-mode
     ;; (projectile :location (recipe :fetcher github :repo "bbatsov/projectile"))
     ;; ivy-hydra
   )
